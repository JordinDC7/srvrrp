...
LANG[ 'hud.weaponsSelector.name' ] = 'HUD выбора оружия'
...
LANG[ 'hud.hud_bar_type.name' ] = 'Тип полоски индикатора'
LANG[ 'hud.hud_bar_type.desc' ] = 'Выберите тип'
...
LANG[ 'hud.alertsCommandHud.name' ] = 'HUD Оповещений Команд'
