...
BRICKS_SERVER.BASECONFIG.GANGS.Achievements = {
    ...
    [6] = { Name = "Cashflow I", Description = "Reach a gang balance of $125,000.", Icon = "balance.png", Category = "Economy", Type = "Balance", ReqInfo = { 125000 }, Rewards = { ["GangBalance"] = { 10000 }, ["GangExperience"] = { 600 } } },
    [7] = { Name = "Cashflow II", Description = "Reach a gang balance of $350,000.", Icon = "balance.png", Category = "Economy", Type = "Balance", ReqInfo = { 350000 }, Rewards = { ["GangBalance"] = { 22000 }, ["GangExperience"] = { 1200 } } },
    [8] = { Name = "Cashflow III", Description = "Reach a gang balance of $750,000.", Icon = "balance.png", Category = "Economy", Type = "Balance", ReqInfo = { 750000 }, Rewards = { ["GangBalance"] = { 40000 }, ["GangExperience"] = { 1900 } } },
    [9] = { Name = "Cashflow IV", Description = "Reach a gang balance of $1,500,000.", Icon = "balance.png", Category = "Economy", Type = "Balance", ReqInfo = { 1500000 }, Rewards = { ["GangBalance"] = { 75000 }, ["GangExperience"] = { 3000 } } },
    [10] = { Name = "Cashflow V", Description = "Reach a gang balance of $3,000,000.", Icon = "balance.png", Category = "Economy", Type = "Balance", ReqInfo = { 3000000 }, Rewards = { ["GangBalance"] = { 130000 }, ["GangExperience"] = { 4600 } } },

    [11] = { Name = "Supply Locker", Description = "Store at least 20 items in gang storage.", Icon = "storage_64.png", Category = "Logistics", Type = "Storage", ReqInfo = { 20 }, Rewards = { ["GangBalance"] = { 8000 }, ["GangExperience"] = { 500 } } },
    [12] = { Name = "Supply Depot", Description = "Store at least 45 items in gang storage.", Icon = "storage_64.png", Category = "Logistics", Type = "Storage", ReqInfo = { 45 }, Rewards = { ["GangBalance"] = { 18000 }, ["GangExperience"] = { 1000 } } },
    [13] = { Name = "Supply Armory", Description = "Store at least 80 items in gang storage.", Icon = "storage_64.png", Category = "Logistics", Type = "Storage", ReqInfo = { 80 }, Rewards = { ["GangBalance"] = { 35000 }, ["GangExperience"] = { 1750 } } },
    [14] = { Name = "Supply Complex", Description = "Store at least 120 items in gang storage.", Icon = "storage_64.png", Category = "Logistics", Type = "Storage", ReqInfo = { 120 }, Rewards = { ["GangBalance"] = { 65000 }, ["GangExperience"] = { 3000 } } },

    [15] = { Name = "Street Presence", Description = "Reach gang level 10.", Icon = "levelling.png", Category = "Progression", Type = "Level", ReqInfo = { 10 }, Rewards = { ["GangBalance"] = { 9000 }, ["GangExperience"] = { 600 } } },
    [16] = { Name = "Regional Threat", Description = "Reach gang level 20.", Icon = "levelling.png", Category = "Progression", Type = "Level", ReqInfo = { 20 }, Rewards = { ["GangBalance"] = { 16000 }, ["GangExperience"] = { 1100 } } },
    [17] = { Name = "Underground Power", Description = "Reach gang level 35.", Icon = "levelling.png", Category = "Progression", Type = "Level", ReqInfo = { 35 }, Rewards = { ["GangBalance"] = { 30000 }, ["GangExperience"] = { 1800 } } },
    [18] = { Name = "District Controller", Description = "Reach gang level 55.", Icon = "levelling.png", Category = "Progression", Type = "Level", ReqInfo = { 55 }, Rewards = { ["GangBalance"] = { 55000 }, ["GangExperience"] = { 3000 } } },
    [19] = { Name = "Metropolis Menace", Description = "Reach gang level 80.", Icon = "levelling.png", Category = "Progression", Type = "Level", ReqInfo = { 80 }, Rewards = { ["GangBalance"] = { 95000 }, ["GangExperience"] = { 4700 } } },
    [20] = { Name = "Empire Ascendant", Description = "Reach gang level 110.", Icon = "levelling.png", Category = "Progression", Type = "Level", ReqInfo = { 110 }, Rewards = { ["GangBalance"] = { 150000 }, ["GangExperience"] = { 7000 } } }
}
