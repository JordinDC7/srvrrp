...
local ITEM = BRICKS_SERVER.Func.CreateItemType("zgo2_baggy")
...
ITEM.GetItemData = function(ent)
	...
	local itemData = { "zgo2_baggy", "models/zerochain/props_growop2/zgo2_baggy.mdl", zgo2.Plant.GetID(ent:GetWeedID()), math.Round(ent:GetWeedAmount()), math.Round(ent:GetWeedTHC()) }
...
if BRICKS_SERVER and BRICKS_SERVER.CONFIG and BRICKS_SERVER.CONFIG.INVENTORY and BRICKS_SERVER.CONFIG.INVENTORY.Whitelist then
	BRICKS_SERVER.CONFIG.INVENTORY.Whitelist[ "zgo2_baggy" ] = { true, true }
end
