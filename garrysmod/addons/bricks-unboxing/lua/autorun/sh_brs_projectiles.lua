...
BRS_UW.Tracers.Tiers = {
    ...
    Glitched = {
        ...
        glowColor = Color(0, 255, 180, 200),
        trailWidth = 4, glowWidth = 20, lifetime = 0.35,
        hasParticles = true, particleColor = Color(0, 255, 220, 240), particleType = "glitch",
        hasImpact = true, impactColor = Color(0, 255, 200, 255), impactSize = 2.0,
        glitchTrail = true, chromatic = true,
        hasAfterimage = true, afterimageColor = Color(255, 0, 180, 40),
        description = "Digital corruption",
    },
    Mythical = {
        color = Color(220, 0, 0, 255), color2 = Color(60, 0, 60, 255),
        glowColor = Color(180, 0, 0, 220),
        trailWidth = 6, glowWidth = 28, lifetime = 0.65,
        hasParticles = true, particleColor = Color(200, 20, 20, 255), particleType = "void",
        hasImpact = true, impactColor = Color(220, 0, 0, 255), impactSize = 3.0,
        voidTrail = true, voidCore = true,
        hasAfterimage = true, afterimageColor = Color(80, 0, 0, 100),
